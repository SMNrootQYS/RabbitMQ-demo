package com.example.smnpproject.util;
...
public class TestQRcode {
     ...
     */
    public static void writeToFile(BitMatrix matrix, String format, OutputStream outStream, String logoPath) throws IOException, IOException {
...
//        g.drawRoundRect(x, y, logoImage.getWidth(), logoImage.getHeight(), 10, 10);
    ...
    public static void main(String[] args) {
        ...
        int fontStyle = 6; // 字体风格
        String text = "测试二维码";
        String withTextPath = "d:/text"+new Date().getTime()+".png";
        pressText(text, withTextPath, path, fontStyle, Color.GRAY, fontSize, width, height);
    }
}
